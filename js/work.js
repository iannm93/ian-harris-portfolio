...
let responsiveContents = document.querySelector(".responsive-contents")
...
let hamburger = () =>{
    if (switched === false){
        ...
        responsiveContents.style.opacity = 1;
        responsiveContents.style.transition = ".4s all"
        ...
        responsiveContents.style.opacity = 0;
        responsiveContents.style.transition = ".4s all"
